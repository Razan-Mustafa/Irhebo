                ...
                <div class="col-span-12">
                    <div class="box p-6 bg-white rounded-lg shadow">
                        <div class="box-header mb-4">
                            <h5 class="text-lg font-semibold text-gray-700">{{ __('edit_admin') }}</h5>
                        </div>
                                    ...
                                    <select name="role" id="role"
                                        ...
                                        @foreach ($roles as $role)
                                            <option value="{{ $role->name }}"
                                                ...
                                                {{ Str::title(Str::replace('_', ' ', $role->name)) }} </option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
...
@push('scripts')
    {!! JsValidator::formRequest('App\Http\Requests\Admin\UpdateAdminRequest') !!}

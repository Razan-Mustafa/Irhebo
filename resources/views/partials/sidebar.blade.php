        ...
        <nav class="main-menu-container nav nav-pills flex-column">
            ...
            @if (auth()->guard('freelancer')->check())
                <ul class="main-menu">
                    ...
                    {{-- <li class="slide">
                    <a href="{{ route('freelancer.filters.index') }}" class="side-menu__item">
                    ...
                    {{-- <li class="slide">
                    <a href="{{ route('freelancer.features.index') }}" class="side-menu__item">
                    ...
                    <li class="slide">
                        <a href="{{ route('freelancer.tickets.index') }}" class="side-menu__item">
                            ...
                            <span class="side-menu__label">{{ __('support_tickets') }} <span
                                    class="text-warning text-[0.75em] rounded-sm badge !py-[0.25rem] !px-[0.45rem] !bg-warning/10 ms-2">3</span></span>
                        </a>
                    </li>
                    <li class="slide has-sub">
                        ...
                        <ul class="slide-menu">
                            <li class="slide has-sub">
                                ...
                                <ul class="slide-menu">
                                    <li class="slide">
                                        <a href="{{ route('freelancer.sliders.mobileSliders') }}" class="side-menu__item">
                                            <i class="bx bx-mobile side-menu__icon"></i>
                                            <span class="side-menu__label">{{ __('mobile_intro_screens') }}</span>
                                        </a>
                                    </li>
                                    <li class="slide">
                                        <a href="{{ route('freelancer.sliders.webSliders') }}" class="side-menu__item">
                            ...
                            <li class="slide">
                                <a href="{{ route('freelancer.professions.index') }}" class="side-menu__item">
                                    <i class="bx bx-hard-hat side-menu__icon"></i>
                                    <span class="side-menu__label">{{ __('professions') }}</span>
                                </a>
                            </li>
                            <li class="slide">
                                <a href="{{ route('freelancer.general.generalInfo') }}" class="side-menu__item">
                                    <i class="bx bx-cog side-menu__icon"></i>
                                    <span class="side-menu__label">{{ __('general') }}</span>
                                </a>
                            </li>
                            <li class="slide">
                                <a href="{{ route('freelancer.general.privacyPolicy') }}" class="side-menu__item">
                                    <i class="bx bx-shield-quarter side-menu__icon"></i>
                                    <span class="side-menu__label">{{ __('privacy_policy') }}</span>
                                </a>
                            </li>
                            <li class="slide">
                                <a href="{{ route('freelancer.general.terms') }}" class="side-menu__item">
                                    <i class="bx bx-lock side-menu__icon"></i>
                                    <span class="side-menu__label">{{ __('terms') }}</span>
                                </a>
                            </li>
                            <li class="slide">
                                <a href="{{ route('freelancer.currencies.index') }}" class="side-menu__item">
                                    <i class="bx bx-dollar-circle side-menu__icon"></i>
                                    <span class="side-menu__label">{{ __('currencies') }}</span>
                                </a>
                            </li>
                            <li class="slide">
                                <a href="{{ route('freelancer.faqs.index') }}" class="side-menu__item">

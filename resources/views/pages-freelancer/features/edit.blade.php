...
@section('title', __('edit_features'))
@push('styles')
...
<div class="content">
    <div class="main-content">
        <div class="block justify-between page-header md:flex">
            <div>
                <h3 class="text-[1.125rem] font-semibold">{{ __('edit_features') }}</h3>
            </div>
            <ol class="flex items-center whitespace-nowrap">
                ...
                <li class="text-[0.813rem] font-semibold text-primary">{{ __('edit_features') }}</li>
            </ol>
        </div>
    </div>
    <div class="container">
            ...
            <div class="col-span-12">
                <div class="box">
                    <div class="box-header">
                        <h5 class="box-title">{{ __('edit_features') }}</h5>
                    </div>
                    <div class="box-body">
                            ...
                            <div class="grid grid-cols-12 gap-4">
                                <div class="col-span-12 md:col-span-6">
                                    ...
                                    <select id="plan-feature" name="plan_id"
                                        ...
                                        <option value="0" {{ $feature->plan_id == 0 ? 'selected' : '' }}>{{ __('all_plans') }}</option>
                                        @foreach ($plans as $plan)
                                            <option value="{{ $plan->id }}" {{ $feature->plan_id == $plan->id ? 'selected' : '' }}>
...
@push('scripts')
    {!! JsValidator::formRequest('App\Http\Requests\Admin\FixedFeatureRequest', '#plan-feature') !!}
@endpush

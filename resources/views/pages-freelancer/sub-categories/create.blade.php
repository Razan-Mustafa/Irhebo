...
@section('title', __('create_sub_category'))
    ...
    <div class="content">
        <div class="main-content">
            ...
            <div class="block justify-between page-header md:flex">
                <div>
                    <h3 class="text-[1.125rem] font-semibold">{{ __('create_sub_category') }}</h3>
                </div>
                <ol class="flex items-center whitespace-nowrap">
                    ...
                    <li class="text-[0.813rem] font-semibold">{{ __('create_sub_category') }}</li>
                </ol>
            </div>
        </div>
        <div class="container">
                ...
                <div class="col-span-12">
                    <div class="box">
                        <div class="box-header">
                            <h5 class="box-title">{{ __('create_sub_category') }}</h5>
                        </div>
                        <div class="box-body">
